			...
			<div class="flex">
				...
				<div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
					...
					@if(auth()->user()->role_name === 'Student')
						...
						<x-nav-link wire:navigate :active="request()->routeIs('education')" href="{{ route('education') }}">Education
						</x-nav-link>
						<x-nav-link wire:navigate :active="request()->routeIs('apply')" href="{{ route('apply') }}">Online Apply
						</x-nav-link>
					@endif
				</div>
			</div>
