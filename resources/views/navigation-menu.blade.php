        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @else
                        @can('manage roles')
                            <x-nav-link wire:navigate :active="request()->routeIs('roles')"
                                        href="{{ route('roles.index') }}">Manage Role
                            </x-nav-link>
                        @endcan
                        @can('manage users')
                            <x-nav-link wire:navigate :active="request()->routeIs('users')" href="{{ route('users') }}">
                                Manage Users
                            </x-nav-link>
                        @endcan
                        @can('manage students')
                            <x-nav-link wire:navigate :active="request()->routeIs('students')"
                                        href="{{ route('students') }}">Manage Students
                            </x-nav-link>
                        @endcan
