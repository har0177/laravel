	...
	<!-- Card Header -->
		...
		<form class="py-6 px-4 sm:px-6" wire:submit.prevent="store" enctype="multipart/form-data">
			<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
				...
				<div>
					<label for="personal_number" class="block text-sm font-medium text-gray-700 mb-1">Personnal Number</label>
				...
				<div>
					<label for="emergency_number" class="block text-sm font-medium text-gray-700 mb-1">Emergency Contact</label>
