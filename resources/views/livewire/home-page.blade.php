<div>
	...
	<div  class="modal fade {{$openModel? 'show' : ''}}" style='display: {{$openModel ? 'block' : 'none'}}' id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	      aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content bg-color text-white">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-newspaper"></i> News & Events</h5>
					<button type="button" wire:click="dismissModel" class="btn-close bg-white" data-bs-dismiss="modal"
					        aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<a href="#" class="text-white text-decoration-none"><strong>PG Admissions Open</strong> - Postgraduate Regular
						Admissions 2023 <small>apply up to 24-08-2023</small></a>
				</div>
			</div>
		</div>
	</div>
