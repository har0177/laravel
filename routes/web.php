...
Route::get('/add-student-info', [HomeController::class, 'addStudentInfo'])->name('add-student-info');
Route::post('/save-student-info', [HomeController::class, 'saveStudentInfo'])->name('save-student-info');
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('admin/send-sms', SMS::class)->name('send-sms')->middleware('can:manage students');
